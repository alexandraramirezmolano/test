...
class NFTProject(models.Model):
    ...
    supply = models.IntegerField(blank=False, default=0)
    ...
    developer_id = models.ForeignKey(config.settings.base.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, blank=True, default=None, related_name="desarrollador")
