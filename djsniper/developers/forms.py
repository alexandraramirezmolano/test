...
class DeveloperProjectForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['developer_id'].widget.attrs.update({'class': 'form-control mt-2','placeholder': 'Descripción','hidden': True})
        self.fields['enterprise_id'].widget.attrs.update({'class': 'form-control mt-2'})
